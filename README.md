...
Σημείωση: Δεν έγινε test για την executeJoin και την executeFilter του IntermediateRepresentation διότι δεν υπάρχει διαφορετικός τρόπος να επιστραφούν τα αποτελέσματα των πράξεων στη δομή από αυτόν που γίνεται στο IntermediateArray όπου έχουν ελεγχθεί ξεχωριστά όλες οι υποπεριπτώσεις.
